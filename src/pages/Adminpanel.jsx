...
// Cleaned: no longer logs local id / backendId / resolved id to the console.
function resolveBackendId(r) {
  return r.backendId ?? r._id ?? r.id;
}
      ...
      {"status" in f && (
        <div className="flex flex-wrap gap-4 items-center">
          ...
          <div className="flex items-center gap-2 mt-5">
            ...
            />
            <label htmlFor="chk-trending" className="text-sm text-gray-600 cursor-pointer">
              Mark as trending 🔥
            </label>
          </div>
        </div>
...
export function AdminPanel() {
  ...
  // Cleaned: removed the debugSync() helper that dumped full raw
  // marketplace payloads (names, emails, phones, IDs) to the console.
  // parseMasterMarketplace(raw) is now called directly.
  ...
  const syncData = async () => {
    ...
    try {
      ...
      let   data = parseMasterMarketplace(raw);
