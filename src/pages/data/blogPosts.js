// data/blogPosts.js  — single source of truth for blog list + detail pages
//
// The AdminPanel writes to two localStorage keys:
//   rnh_blog_posts_v1    — the posts array
//   rnh_blog_featured_v1 — the featured article object
//
// loadBlogPosts() and loadFeatured() read those keys and fall back to the
// hardcoded defaults below when nothing has been saved yet.
// BlogPage and BlogPostPage should call these functions instead of importing
// `posts` and `featured` directly.
...
/**
 * Returns the live posts array.
 * Priority: localStorage → static defaults.
 * Only Published posts are returned (drafts are admin-only).
 * Pass `{ includeDrafts: true }` to get all posts (used by AdminPanel preview).
 */
  ...
  try {
    ...
    if (raw) {
      ...
      if (Array.isArray(stored) && stored.length > 0) {
        return includeDrafts ? stored : stored.filter((p) => p.status !== "Draft");
      }
    }
  } catch { /* fall through */ }
  // Fall back to static defaults — add a status field so the shape is consistent
...
/**
 * Returns the featured article object.
 * Priority: localStorage → static default.
 */
export function loadFeatured() {
  try {
    ...
    if (raw) {
      const stored = JSON.parse(raw);
      if (stored && typeof stored === "object" && stored.title) return stored;
    }
  } catch { /* fall through */ }
...
// ─────────────────────────────────────────────────────────────────────────────
// Static defaults
// These are used on first load before the admin has saved anything.
// The AdminPanel will write these to localStorage on its first render
// (via the dynamic import in BlogSection's useEffect), so subsequent
// loads will come from localStorage.
// ─────────────────────────────────────────────────────────────────────────────
...
export const staticPosts = [
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "1. Define the Role Before You Recruit",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "3. Assess Temperament, Not Just Skills",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "4. Set Clear Expectations from Day One",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "5. Trial Periods Are Your Friend",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "The Numbers Behind the Trend",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "What Businesses Are Outsourcing",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "The Risk of Getting It Wrong",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "How to Choose the Right Partner",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "Patience Is a Practice, Not a Personality",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Presence Over Performance",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Professional Boundaries Matter",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "The Invisible Work of Great Domestic Staff",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Discretion as a Professional Virtue",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Building Long-Term Relationships",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "What Randle & Hopkick Looks For",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "Question 1: Can You Walk Me Through Your Driving History?",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Question 2: How Do You Handle a Difficult Traffic Situation?",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Question 3: Have You Ever Been in an Accident? What Happened?",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Question 4: How Do You Define Discretion?",
      },
      {
        type: "paragraph",
      ...
      {
        type: "heading",
        text: "Question 5: What Would You Do If Instructed to Do Something Unsafe?",
      },
      {
        type: "paragraph",
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: "heading",
        text: "A Message from Leadership",
      },
      {
        type: "paragraph",
...
export const staticFeatured = {
  ...
  content: [
    ...
    {
      type: "heading",
      text: "The Hidden Cost of Cheap Staffing",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "What 'Premium' Actually Means",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Our Approach at Randle & Hopkick",
    },
    {
      type: "paragraph",
...
// Any file that still does `import { posts, featured } from "./data/blogPosts"`
// will keep working — but prefer loadBlogPosts() / loadFeatured() for live data.
// ─────────────────────────────────────────────────────────────────────────────
